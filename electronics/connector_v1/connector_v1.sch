...
<library name="LucasParis">
<packages>
<package name="APA102STRIP">
<smd name="GND" x="-3.775" y="1" dx="10" dy="1.27" layer="1" rot="R90"/>
<smd name="DATA" x="-1.225" y="1" dx="10" dy="1.27" layer="1" rot="R90"/>
<smd name="CLOCK" x="1.225" y="1" dx="10" dy="1.27" layer="1" rot="R90"/>
<smd name="5V" x="3.775" y="1" dx="10" dy="1.27" layer="1" rot="R90"/>
<pad name="DATA2" x="-1.225" y="0" drill="1" diameter="1.7"/>
<pad name="CLOCK2" x="1.225" y="0" drill="1" diameter="1.7"/>
<pad name="5V2" x="3.775" y="0" drill="1" diameter="1.7"/>
<pad name="GND2" x="-3.775" y="0" drill="1" diameter="1.7"/>
</package>
</packages>
<symbols>
<symbol name="APA102STRIP">
...
<pin name="CLOCK" x="-10.16" y="-2.54" length="middle"/>
<pin name="5V" x="-10.16" y="-7.62" length="middle"/>
</symbol>
</symbols>
<devicesets>
<deviceset name="APA102STRIP">
<gates>
<gate name="G$1" symbol="APA102STRIP" x="0" y="0"/>
</gates>
<devices>
<device name="" package="APA102STRIP">
<connects>
<connect gate="G$1" pin="5V" pad="5V 5V2"/>
<connect gate="G$1" pin="CLOCK" pad="CLOCK CLOCK2"/>
<connect gate="G$1" pin="DATA" pad="DATA DATA2"/>
...
<part name="OUT1" library="SparkFun-Connectors" deviceset="CONN_05X2" device="SHD_LOCK"/>
<part name="GND1" library="supply1" deviceset="GND" device=""/>
<part name="IN1" library="SparkFun-Connectors" deviceset="CONN_05X2" device="SHD_LOCK"/>
<part name="IN+" library="SparkFun-Connectors" deviceset="M01" device="PTH_2MM"/>
<part name="IN-" library="SparkFun-Connectors" deviceset="M01" device="PTH_2MM"/>
<part name="OUT+" library="SparkFun-Connectors" deviceset="M01" device="PTH_2MM"/>
<part name="OUT-" library="SparkFun-Connectors" deviceset="M01" device="PTH_2MM"/>
<part name="INSTRIP3" library="LucasParis" deviceset="APA102STRIP" device=""/>
<part name="INSTRIP2" library="LucasParis" deviceset="APA102STRIP" device=""/>
<part name="INSTRIP1" library="LucasParis" deviceset="APA102STRIP" device=""/>
<part name="OUTSTRIP3" library="LucasParis" deviceset="APA102STRIP" device=""/>
<part name="OUTSTRIP2" library="LucasParis" deviceset="APA102STRIP" device=""/>
<part name="OUTSTRIP1" library="LucasParis" deviceset="APA102STRIP" device=""/>
...
<sheet>
<plain>
<text x="-104.14" y="60.96" size="1.778" layer="91">3 * rj 45 connectors</text>
<text x="-104.14" y="68.58" size="1.778" layer="91">3 * ribbon connectors</text>
<text x="-104.14" y="53.34" size="1.778" layer="91">screw terminals</text>
<text x="-104.14" y="45.72" size="1.778" layer="91">customs traces</text>
</plain>
<instances>
<instance part="GND2" gate="1" x="83.82" y="38.1"/>
<instance part="OUT1" gate="G$1" x="83.82" y="63.5" rot="R270"/>
<instance part="GND1" gate="1" x="83.82" y="-22.86"/>
<instance part="IN1" gate="G$1" x="83.82" y="2.54" rot="R270"/>
<instance part="IN+" gate="G$1" x="96.52" y="127" rot="MR0"/>
<instance part="IN-" gate="G$1" x="96.52" y="114.3" rot="MR0"/>
<instance part="OUT+" gate="G$1" x="63.5" y="127"/>
<instance part="OUT-" gate="G$1" x="63.5" y="114.3"/>
<instance part="INSTRIP3" gate="G$1" x="10.16" y="12.7" rot="MR0"/>
<instance part="INSTRIP2" gate="G$1" x="5.08" y="-12.7" rot="MR0"/>
<instance part="INSTRIP1" gate="G$1" x="-10.16" y="-40.64" rot="MR0"/>
<instance part="OUTSTRIP3" gate="G$1" x="10.16" y="96.52" rot="R180"/>
<instance part="OUTSTRIP2" gate="G$1" x="10.16" y="71.12" rot="R180"/>
<instance part="OUTSTRIP1" gate="G$1" x="10.16" y="45.72" rot="R180"/>
...
<instance part="GND7" gate="1" x="22.86" y="-25.4"/>
<instance part="GND8" gate="1" x="22.86" y="-53.34"/>
<instance part="GND9" gate="1" x="81.28" y="99.06"/>
</instances>
<busses>
</busses>
<nets>
...
<pinref part="IN1" gate="G$1" pin="8"/>
...
<pinref part="INSTRIP1" gate="G$1" pin="5V"/>
...
<pinref part="INSTRIP2" gate="G$1" pin="5V"/>
...
<pinref part="INSTRIP3" gate="G$1" pin="5V"/>
...
<pinref part="OUTSTRIP1" gate="G$1" pin="GND"/>
...
<pinref part="OUTSTRIP2" gate="G$1" pin="GND"/>
<wire x1="22.86" y1="63.5" x2="20.32" y2="63.5" width="0.1524" layer="91"/>
</segment>
<segment>
<pinref part="OUTSTRIP3" gate="G$1" pin="GND"/>
...
<pinref part="OUTSTRIP3" gate="G$1" pin="CLOCK"/>
...
<pinref part="OUTSTRIP3" gate="G$1" pin="DATA"/>
...
<pinref part="OUTSTRIP2" gate="G$1" pin="CLOCK"/>
...
<wire x1="35.56" y1="68.58" x2="60.96" y2="68.58" width="0.1524" layer="91"/>
</segment>
</net>
...
<pinref part="OUTSTRIP2" gate="G$1" pin="DATA"/>
...
<pinref part="OUTSTRIP1" gate="G$1" pin="CLOCK"/>
...
<pinref part="OUTSTRIP1" gate="G$1" pin="DATA"/>
...
<pinref part="IN1" gate="G$1" pin="9"/>
<wire x1="40.64" y1="15.24" x2="40.64" y2="12.7" width="0.1524" layer="91"/>
<pinref part="INSTRIP3" gate="G$1" pin="DATA"/>
...
<pinref part="IN1" gate="G$1" pin="10"/>
<pinref part="INSTRIP3" gate="G$1" pin="CLOCK"/>
...
<pinref part="INSTRIP2" gate="G$1" pin="DATA"/>
...
<pinref part="INSTRIP2" gate="G$1" pin="CLOCK"/>
...
<pinref part="INSTRIP1" gate="G$1" pin="DATA"/>
...
<pinref part="INSTRIP1" gate="G$1" pin="CLOCK"/>
...
<wire x1="48.26" y1="101.6" x2="48.26" y2="20.32" width="0.1524" layer="91"/>
